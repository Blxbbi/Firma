...
class Orchestrator:
    ...
    async def _handle_worker_timeouts(self):
        ...
        # Synchronized with Scheduler's ack_timeout (320s provider max + buffer)
        SOFT_TIMEOUT_THRESHOLD = timedelta(seconds=60)
        HARD_TIMEOUT_THRESHOLD = timedelta(seconds=320)
